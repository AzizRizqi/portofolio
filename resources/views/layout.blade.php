                        ...
                        <div class="app-utilities col-auto">
                            ...
                            <div class="app-utility-item app-user-dropdown dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
                                    <li><a class="dropdown-item" href="{{ asset('profiles') }}">Portofolio</a></li>
                                    <li>
            ...
            <div class="sidepanel-inner d-flex flex-column">
                ...
                <div class="app-branding">
                    <a class="app-logo" href="index.html"><img class="logo-icon me-2"
                            src="{{ asset('admin/assets/images/logo.png') }}" alt="logo"><span
                            class="logo-text">PORTAL Portofolio</span></a>
                ...
                <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                        <li class="nav-item">
                            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                            <a class="nav-link active" href="{{ asset('dashboard') }}">
                                <span class="nav-icon">
                            ...
                            <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                                <ul class="submenu-list list-unstyled">
                                    <li class="submenu-item"><a class="submenu-link"
                                            href="{{ route('pengalaman.index') }}">Pengalaman</a></li>
                                    <li class="submenu-item"><a class="submenu-link"
                                            href="{{ route('pendidikan.index') }}">Pendidikan</a>
                                    </li>
                                    <li class="submenu-item"><a class="submenu-link"
                                            href="{{ route('skill.index') }}">Skill</a>
                                    </li>
                                    <li class="submenu-item"><a class="submenu-link"
    ...
    <div class="app-wrapper">
        ...
        <footer class="app-footer">
            <div class="container text-center py-3">
                ...
                <small class="copyright">Portofolio by <span class="sr-only">love</span><i class="fas fa-heart"
                        style="color: #fb866a;"></i> by <a class="app-link" href="http://themes.3rdwavemedia.com"
                        target="_blank">Aziz Rizqi</a> for developers</small>
